...
public class ChatroomManagement {
     ...
     */
    @Transactional
    public Chatroom findChatroomWithMembers(MemberSync currentMember, MemberSync otherMember, Long postId, String postTitle, List<HelpCategorySync> helpCategories) {
        return chatroomRepository.findChatroomWithMembers(currentMember, otherMember, postId)
                .orElseGet(() ->
                        chatroomRepository.save(currentMember, otherMember, postId, postTitle, helpCategories));
    }
