...
class PreparePaymentUseCaseTest {
    ...
    class ExecuteTest {
        ...
        void execute_withValidParams_createsOrderIdAndSavesToRedis() {
            ...
            given(tempPaymentPort.save(testMemberId, testAmount)).willReturn(expectedOrderId);
            ...
            then(tempPaymentPort).should().save(testMemberId, testAmount);
        }
        ...
        void execute_withDifferentMemberId_createsDifferentOrderId() {
            ...
            given(tempPaymentPort.save(memberId1, testAmount)).willReturn(orderId1);
            given(tempPaymentPort.save(memberId2, testAmount)).willReturn(orderId2);
        ...
        void execute_withMinimumAmount_succeeds() {
            ...
            given(tempPaymentPort.save(testMemberId, minAmount)).willReturn(expectedOrderId);
        ...
        void execute_withMaximumAmount_succeeds() {
            ...
            given(tempPaymentPort.save(testMemberId, maxAmount)).willReturn(expectedOrderId);
